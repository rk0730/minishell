...
static int	ft_exec_cmd_h(t_cmd_info cmd_info, t_env_info env_info, int read_pipe, int write_pipe)
{
	...
	return (ft_call_builtin(cmd_info, env_info, read_pipe, write_pipe));
}

static void	ft_exec_cmd_child(t_cmd_info cmd_info, t_env_info env_info, int read_pipe, int write_pipe)
{
	char	**path_array;
	char	**cmd_env;
...
int	ft_exec_cmd(t_cmd_info cmd_info, t_env_info env_info, int read_pipe, int write_pipe)
{
	...
	if (pid == -1)
		...
		ft_exec_cmd_child(cmd_info, env_info, read_pipe, write_pipe);
	else
	{
