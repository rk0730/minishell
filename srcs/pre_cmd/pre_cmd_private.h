...
/*   Updated: 2024/12/14 18:52:01 by yyamasak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*_ft_expand_env(char *word, t_env_info env_info,
				int is_doublequote);
...
char		*_ft_expand_normal(char *str, int i, int *endp,
				t_env_info env_info);
...
int			_ft_one_heredoc(t_env_info *env_info_p, int pipe_fd[2],
				char *limiter, int is_quote);
...
int			_ft_in_fd(char **tokens, t_cmd_info *cmd_info, t_env_info env_info,
				int i);
